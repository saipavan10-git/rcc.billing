...
project_ownership_records_with_issues_and_no_updates <- redcap_entity_project_ownership %>%
  ...
  select(pid, reason, email, firstname, lastname, username, created, updated)
