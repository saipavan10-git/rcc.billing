...
init_etl("mirror_all_redcap_projects_to_history")
...
# Create a 0-row target with matching types from source
redcap_projects_history_for_first_sync <- redcap_projects_source_typed[0, , drop = FALSE]
...
sync_activity_results <- redcapcustodian::sync_table_2(
  ...
  target = redcap_projects_history_for_first_sync,
