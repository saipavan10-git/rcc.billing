...
testthat::test_that("get_service_request_lines returns multiple lines of paid service", {
...
testthat::test_that("get_service_request_lines returns Paid and Probono lines", {
